        ...
        <div class="row mt-4" style="margin-left:20%;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; border:1px solid #348CD4 " >
            <div class="col-12 col-lg-12">
                ...
                <div class="row" style="font-size:medium">
                    <div class="col-sm-6">
                        <div>
                            <span class="text-sm text-grey-m2 align-middle">Maneger:</span>
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#348CD4"></i> <span class="text-600 text-90">ID:{{$report->id}}</span> </div>

                            <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#348CD4"></i> <span class="text-600 text-90">Report Date:</span> {{$report->report_date}}</div>

                            <!-- <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#348CD4"></i> <span class="text-600 text-90">Status:</span> <span class="badge badge-warning badge-pill px-25">Unpaid</span></div> -->
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
                ...
                <table class="table table-striped table-borderless border-0 border-b-2 brc-default-l1">
                    <thead class="bg-none bgc-default-tp1">
                        <tr class="text-white">
                            ...
                            <th width="140">Remaining Work</th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="text-95 text-secondary-d3">
                        ...
                        <tr>    
                            ...
                            <td>{{$detail->project_location}}</td>
                            <td class="text-95">{{$detail->completed_work}}</td>
                            <td class="text-secondary-d2">{{$detail->remaining_work}}</td>

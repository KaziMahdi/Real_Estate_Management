    ...
    <div class="container px-0">
        <div class="row mt-4" style="margin-left:20%" >
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12">
                        <div class="text-center text-150">
                            ...
                            <span class="text-default-d3">Kazi Shop</span>
                        </div>
                    </div>
                </div>
                <!-- .row -->
                ...
                <div class="row" style="font-size:medium">
                    <div class="col-sm-6">
                        <div>
                            ...
                            <span class="text-600 text-110 text-blue align-middle">Shuvo Khan</span>
                        </div>
                        <div class="text-grey-m2">
                            ...
                            <div class="my-1"><i class="fa fa-phone fa-flip-horizontal text-secondary"></i> <b class="text-600">0175-8925468</b></div>
                        </div>
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#9370DB"></i> <span class="text-600 text-90">ID:</span> #111-222</div>

                            <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#9370DB"></i> <span class="text-600 text-90">Issue Date:</span> Oct 12, 2019</div>

                            <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#9370DB"></i> <span class="text-600 text-90">Status:</span> <span class="badge badge-warning badge-pill px-25">Unpaid</span></div>
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
                ...
                <div class="mt-4">
                    <div class="row text-700 text-white bgc-default-tp1 py-25" style="font-size:medium">
                    ...
                    <div class="text-95 text-secondary-d3" style="font-size:medium">

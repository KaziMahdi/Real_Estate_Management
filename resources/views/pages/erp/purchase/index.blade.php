                                                            ...
                                                            <tr>
                                                                ...
                                                                <form action="{{route('purchases.destroy',$purchase->id)}}" method="post">
                                                                    <div class="btn-group" role="group">
                                                                        <a href="{{route('purchases.edit',$purchase->id)}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" class="btn btn-light " style="color: green;"><i class="fas fa-edit"></i></a><a>
                                                                        </a><a href="{{route('purchases.show',$purchase->id)}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Details" class="btn btn-light text-info"><i class="fas fa-search-plus"></i></a><a>
                                                                            @method('DELETE')
                                                                            @csrf

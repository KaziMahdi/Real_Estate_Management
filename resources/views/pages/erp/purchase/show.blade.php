        ...
        <div class="row mt-4" style="margin-left:20%;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; border:1px solid #348CD4 " >
            <div class="col-12 col-lg-12">
                ...
                <div class="row" style="font-size:medium">
                    <div class="col-sm-6">
                        <div>
                            <span class="text-sm text-grey-m2 align-middle">Supplier Name:</span>
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-1"><i class="fa fa-phone fa-flip-horizontal text-secondary"></i> <b class="text-600">{{$warehouse->mobile}}</b></div>
                        </div>
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#348CD4"></i> <span class="text-600 text-90">ID:</span> {{$purchase->id}}</div>

                            <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#348CD4"></i> <span class="text-600 text-90">Purchase Date:</span> {{$purchase->purchase_date}}</div>

                            <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#348CD4"></i> <span class="text-600 text-90">Delivery Date:</span> {{$purchase->delivery_date}}</div>
                        </div>
                    </div>
                    <!-- /.col -->
                </div>

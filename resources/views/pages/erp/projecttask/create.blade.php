                                                ...
                                                <div class="card" style="margin-top: 20px;">
                                                    <div class="card-header bg-light" style="height: 70px;">
                                                        <div class="w-100 d-flex justify-content-between align-items-end">
                                                            <h4 class="color-primary">Create Project Task</h4>
                                                            <a href="{{'/projecttasks'}}" class="btn btn rounded" style="background-color:#9370DB;color:azure"><i class="fas fa-wrench mr-1"></i> Manage Project Task</a>
                                                        </div>
                                                    </div>

                                                    <form action="{{route('projecttasks.store')}}" method="POST" enctype="multipart/form-data">

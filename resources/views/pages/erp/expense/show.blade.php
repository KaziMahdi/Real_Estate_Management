        ...
        <div class="row mt-4" style="margin-left:20%;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; border:1px solid #348CD4 " >
            <div class="col-12 col-lg-12">
                ...
                <div class="row" style="font-size:medium">
                    <div class="col-sm-6">
                        <div>
                            <span class="text-sm text-grey-m2 align-middle">Maneger Name:</span>
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#348CD4"></i> <span class="text-600 text-90">ID:</span>{{$expense->id}}</div>

                            <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#348CD4"></i> <span class="text-600 text-90">Expense Date:</span>{{$expense->expenses_date}}</div>

                            <!-- <div class="my-2"><i class="fa fa-circle  text-xs mr-1" style="color:#348CD4"></i> <span class="text-600 text-90">Delivery Date:</span> Mar 1, 2023</div> -->
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-borderless border-0 border-b-2 brc-default-l1">
                    ...
                    <tbody class="text-95 text-secondary-d3">
                        ...
                        <tr>
                            <td>{{++$sn}}</td>
                            <td>{{$exdetail->pname}}</td>
                            <td>{{$exdetail->tname}}</td>
                            <td class="text-95">{{$exdetail->mname}}</td>
                            <td class="text-95">{{$exdetail->qty}}</td>
                            <td class="text-secondary-d2">{{$exdetail->uname}}</td>
                        </tr> 
                        @endforeach
                    </tbody>
                </table>

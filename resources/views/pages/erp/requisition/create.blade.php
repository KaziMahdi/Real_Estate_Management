              ...
              <div class="row">
                <div class="col-12">
                  <h2 style="text-align: center;">
                    ...
                    <button type="button" class="btn btn mt-1" style="background-color: #00a7c7;color:aliceblue">Requisition Form</button><br>
              ...
              <div class="row invoice-info" style="font-size:16px;">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    ...
                    <tr>
                      <td><b><i class="fa fa-circle  text-xs mr-1" style="color:#00a7c7"></i> Date:</b></td>
                      <td><input type="text" style="width:150px" id="txtrequiDate" value=<?php echo date("d-m-Y"); ?> /></td>
                    </tr>
                    <tr>
                  <td><b><i class="fa fa-circle  text-xs mr-1" style="color:#00a7c7"></i> Status:</b></td>
                  <td><input type="text" style="width:150px" id="txtstatus" value= ></td>
                </tr>
                  </table>
                </div>
                <!-- /.col -->
                  ...
                  <table class="table table-striped" style="color:aliceblue">
                    <thead>
                      ...
                      <tr>
                        ...
                        <th>
                        <select id="cmbMaterial" name="materials_id" style="width: 150px;">
    ...
    <script>
      $(function() {
        ...
        $("#btnProcessOrder").on("click",function(e){
          ...
          let requisition_date=$("#txtrequiDate").val();
          console.log(requisition_date)
          ...
          let requisitions=JSON.parse(localStorage.getItem("cart"));
          ...
          $.ajax({
            ...
            data:{
              _token:token,
              _method:method,
              'txtEmployee':employee_id,
              'txtdate':requisition_date,
              'txtstatus':status,
              'txtremark':remark,
              'txtrequisitions':requisitions
            },
        ...
        function AddtoCart(){
            ...
            let ptname=$("#cmbProjectTask option:selected").text();
